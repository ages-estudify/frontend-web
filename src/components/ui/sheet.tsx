    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          'data-[side=center]:left-1/2 data-[side=center]:top-1/2 data-[side=center]:w-full data-[side=center]:-translate-x-1/2 data-[side=center]:-translate-y-1/2 data-[side=center]:rounded-2xl data-[side=center]:border',
          ...
          'data-[side=center]:data-open:zoom-in-95',
          ...
          'data-[side=center]:data-closed:zoom-out-95',
          className
        )}
        {...props}
      >
